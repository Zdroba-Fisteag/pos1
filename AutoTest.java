...
public class AutoTest
{
    ...
    public void Test_printAuto(){
        ...
        Person ferdi = new Person("Maria", true, 181, 200); //Fahrer
        BMW.einsteigen(ferdi);
        Person marie = new Person("Anna", false, 160, 200); //Beifahrerin
        BMW.einsteigen(marie);
        Person hans = new Person("Markus", true, 170, 200); //Rückbank
        BMW.einsteigen(hans);
